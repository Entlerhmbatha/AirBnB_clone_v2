...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        """ ikhanda an object of any class"""
    ...
    def help_create(self):
        """ isiza information for the create method """
    ...
    def help_destroy(self):
        """ isiza information for the destroy command """
        print("Destroys an individual instance of a class")
        print("[Usage]: destroy <className> <objectId>\n")

    def do_all(self, args):
        """ iveza all objects, or all objects of a class"""
        print_list = []
    ...
    def help_all(self):
        """ isaza information for the all command """
        print("Shows all objects, or all of a class")
        print("[Usage]: all <className>\n")

    def do_count(self, args):
        """ibala current number of class instances"""
        count = 0
        for k, v in storage.all().items():
            if args == k.split('.')[0]:
                count += 1
    ...
    def do_update(self, args):
        """ Uvusele a object thizeni with new info """
    ...
    def help_update(self):
        """ isiza information for the update class """
