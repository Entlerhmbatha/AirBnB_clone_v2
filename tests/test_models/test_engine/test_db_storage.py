#!/usr/bin/python3
""" Module yo kutesta i-file storage"""
import MySQLdb
import os
import unittest
...
class TestDBStorage(unittest.TestCase):
    """ Class ezo testa i-database storage method """
    def test_new(self):
        """ i-object entsha igcinwe ngokufanele kwi database """
        new = User(
    ...
    def test_save(self):
        """ object igcineke ngempumelelo kwi database """
        new = User(
            email='john2020@gmail.com',
            password='password',
            first_name='John',
    ...
    def test_new_and_save(self):
        '''testa entsha bese igcina ama methods'''
