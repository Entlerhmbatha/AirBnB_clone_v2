...
class TestBasemodel(unittest.TestCase):
    ...
    def test_kwargs_one(self):
        """itesta kwargs with one key-value pair."""
        n = {'Name': 'test'}
        new = self.value(**n)
        self.assertTrue(hasattr(new, 'Name'))

    def test_id(self):
        """i-testa the type of id."""
        new = self.value()
        self.assertEqual(type(new.id), str)

    def test_created_at(self):
        """iteesta the type of created_at."""
        new = self.value()
        self.assertEqual(type(new.created_at), datetime)

    def test_updated_at(self):
        """testa type of updated_at."""
        new = self.value()
    ...
    def test_delete(self):
        """itesta function esusa of the BaseModel class."""
