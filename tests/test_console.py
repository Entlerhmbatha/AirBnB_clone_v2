...
class TestHBNBCommand(unittest.TestCase):
    """imele test class for the HBNBCommand class.
    """
    @unittest.skipIf(
        os.getenv('HBNB_TYPE_STORAGE') == 'db', 'FileStorage test')
    def test_fs_create(self):
        """itesta create command with the file storage.
        """
    ...
    def test_db_create(self):
        """itesta create command nge database storage.
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
    ...
    def test_db_show(self):
        """itesta show command with the database storage.
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
    ...
    def test_db_count(self):
        """itesta count command with the database storage.
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
            dbc = MySQLdb.connect(
