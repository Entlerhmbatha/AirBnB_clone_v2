#!/usr/bin/python3
"""Le module ichaza i-class to manage database storage for hbnb clone"""
import os
...
class DBStorage:
    """Le class manages storage se hbnb models in a SQL database"""
    __engine = None
    __session = None

    def __init__(self):
        """Iqala i-SQL database storage"""
    ...
    def all(self, cls=None):
        """ibuyisa a dictionary of models currently in storage"""
        objects = dict()
