...
"""imele the many to many ubudlelwane table
phakathi Place and Amenity records.
"""
...
class Place(BaseModel, Base):
    ...
    if os.getenv('HBNB_TYPE_STORAGE') == 'db':
        ...
        @property
        def amenities(self):
            """ibuyisa ama amenities of this Place"""
        ...
        @property
        def reviews(self):
            """ibuyisa ama reviews of this Place"""
            from models import storage
            reviews_of_place = []
